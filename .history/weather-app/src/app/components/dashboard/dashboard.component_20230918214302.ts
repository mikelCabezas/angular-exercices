...
export class DashboardComponent implements OnInit {
  ...
  getWeather() {
    ...
    this._weatherService.getWeather(this.city).subscribe(data => {
      ...
      this.humidity1h = data.list[0].main.humidity
      ...
      this.humidity2h = data.list[1].main.humidity
      ...
      this.humidity3h = data.list[2].main.humidity
      ...
      this.humidity4h = data.list[3].main.humidity
      ...
      this.humidity5h = data.list[4].main.humidity
