...
export class DashboardComponent implements OnInit {
  ...
  getWeather() {
    ...
    this._weatherService.getWeather(this.city).subscribe(data => {
      ...
      this.pop1h = data.list[0].main.pop
      ...
      this.pop2h = data.list[1].main.pop
      ...
      this.pop3h = data.list[2].main.pop
      ...
      this.pop4h = data.list[3].main.pop
      ...
      this.pop5h = data.list[4].main.pop
